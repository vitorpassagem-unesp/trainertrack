            ...
            <div className="progress-grid">
                ...
                <div className="metric-card">
                    ...
                    <div className="card-content">
                        ...
                        {previous && (
                            <div className="metric-change">
                                {formatChange(calculateChange(latest, previous, 'bodyFat'))}%
                            </div>
                        )}
                        {latest?.date && (
                            <div className="metric-date">
                ...
                <div className="metric-card">
                    ...
                    <div className="card-content">
                        <div className="metric-value">
                            {latest?.muscleMass ? `${latest.muscleMass}%` : '--'}
                        </div>
                        {previous && (
                            <div className="metric-change">
                                {formatChange(calculateChange(latest, previous, 'muscleMass'))}%
                            </div>
                        )}
                        {latest?.date && (
                            <div className="metric-date">
                    ...
                    <div className="history-table">
                        ...
                        {metrics.slice(-10).reverse().map((metric, index) => (
                            <div key={index} className="table-row">
                                ...
                                <span>{metric.bodyFat ? `${metric.bodyFat}%` : '--'}</span>
                                <span>{metric.muscleMass ? `${metric.muscleMass}%` : '--'}</span>
                            </div>
                        ))}
                    </div>
                </div>
